...
import static com.fuze.potryservice.controller.Ai.AgentCharacterController.preSetMessages;
...
public class BigModelNew extends WebSocketListener {
    ...
    private static final String appid = "c849a34c";
    private static final String apiSecret = "MmFlNDFkZmUyNWI1OTA4YWYwYjVkMzE1";
    private static final String apiKey = "bbbded440b61c3302195a28c33df1701";
    ...
    public static  String NewQuestion = "生成一首古诗，无论发回来的是什么都只什么生成古诗";
    ...
    // 主函数
    public void editAgentCharacter(String s) throws Exception {
        // 个性化参数入口，如果是并发使用，可以在这里模拟
          if(totalFlag){
              Scanner scanner=new Scanner(System.in);
              System.out.print("我：");
//              if (!preSetMessages.isEmpty()) {
//                  System.out.println(preSetMessages);
//                  String presetMessage = preSetMessages.remove(0);
//                  System.out.println(presetMessage);
//                  NewQuestion = s;
//
//              } else {
